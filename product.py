...
class productClass:
    def __init__(self,root):
       ...
       # Buttons
        btn_add=Button(product_Frame,text="Save",command=self.add,font=("goudy old style",17),bg="#2196f3",fg="white",cursor="hand2").place(x=10,y=400,width=80,height=40)
        btn_update=Button(product_Frame,text="Update",command=self.update,font=("goudy old style",17),bg="#4caf50",fg="white",cursor="hand2").place(x=100,y=400,width=80,height=40)
        btn_delete=Button(product_Frame,text="Delete",command=self.delete,font=("goudy old style",17),bg="#f44336",fg="white",cursor="hand2").place(x=200,y=400,width=80,height=40)
        btn_clear=Button(product_Frame,text="Clear",command=self.Clear,font=("goudy old style",17),bg="#607d8d",fg="white",cursor="hand2").place(x=300,y=400,width=80,height=40)

        # Search Frame
        SearchFrame=LabelFrame(self.root,text="Search Employee",font=("goudy old style",12,"bold"),bd=2,relief=RIDGE,bg="white")
        SearchFrame.place(x=420,y=10,width=580,height=80)
        ...
        btn_search=Button(SearchFrame,text="Search",command=self.Search,font=("goudy old style",18),bg="#4caf50",fg="white",cursor="hand2").place(x=410,y=9,width=150,height=30)

        #  Product Details

        p_frame=Frame(self.root,bd=3,relief=RIDGE)
        p_frame.place(x=420,y=100,width=580,height=390)
