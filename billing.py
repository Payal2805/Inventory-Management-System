...
class BillClass:
    def __init__(self,root):
        ...
        lbl_name=Label(product_frame2,text="Product Name",font=("times new roman",15,"bold"),bg="white").place(x=2,y=45)
        txt_name=Entry(product_frame2,textvariable=self.var_search,font=("times new roman",15),bg="lightyellow").place(x=128,y=47,width=150,height=22)
        ...
        btn_searchall=Button(product_frame2,text="Search All",command=self.show,font=("goudy old style",15),bg="#083531",fg="white",cursor="hand2").place(x=285,y=10,width=100,height=25)
        ...
        txt_name=Entry(customer_frame,textvariable=self.var_cname,font=("times new roman",13),bg="lightyellow").place(x=80,y=35,width=180)

        lbl_contact=Label(customer_frame,text="Contact No.",font=("times new roman",15),bg="white").place(x=270,y=35)
        txt_contact=Entry(customer_frame,textvariable=self.var_contact,font=("times new roman",13),bg="lightyellow").place(x=380,y=35,width=140)
        ...
        BTitle=Label(billFrame,text="Customer Bill Area",font=("goudy old style",20,"bold"),bg="#FF8000",fg="white").pack(side=TOP,fill=X)
        ...
        self.lbl_pay=Label(billMenuFrame,text="Net Pay\n[0]",font=("goudy old style",15,"bold"),bg="#607d8b",fg="white")
        self.lbl_pay.place(x=246,y=5,width=145,height=70)
        ...
        # Footer 
        lbl_footer=Label(self.root,text="IMS-Inventory Management System  |  Developed By Payal \n For any Technical Issue Contact: 7264xxxx45",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
# *******************************All Functions *********************************************
    ...
    def add_update_cart(self):
        if  self.var_pid.get()=="":
            ...
            messagebox.showerror("Error","Invalied Quantity",parent=self.root)
        else:
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tRoyal-Inventory
\t Phone No. 726496xxxx , Khed-41570
{str("="*46)}
    ...
    def bill_middle(self):
        ...
        try:
            for row in self.cart_list:
                ...
                price=float(row[2]) *int(row[3])   # only 1 product price
                price=str(price)
