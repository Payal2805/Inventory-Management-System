...
class IMS:
    def __init__(self,root):
        ...
        self.MenuLogo=Image.open("Images\menu1.jpg")
        self.MenuLogo=self.MenuLogo.resize((295,200))    #,Image.ANTIALIAS
        self.MenuLogo=ImageTk.PhotoImage(self.MenuLogo)

        lbl_menuLgo=Label(LeftMenu,image=self.MenuLogo)
        lbl_menuLgo.pack(side=TOP,fill=X)

        lbl_menu=Label(LeftMenu,text="Menu",font=("times new roman",20),bg="#009688").pack(side=TOP,fill=X)
        self.icon_side=PhotoImage(file="Images\logo.png")  
        ...
        btn_product=Button(LeftMenu,text="Products",command=self.product,image=self.icon_side,compound=LEFT,padx=15,anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        ...
        self.lbl_employee.place(x=330,y=120,height=150,width=300)

        self.lbl_supplier=Label(self.root,text="Total Supplier\n [ 0 ]",bd=5,relief=RIDGE,bg="#ff5722",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_supplier.place(x=660,y=120,height=150,width=300)

        self.lbl_category=Label(self.root,text="Total Category\n [ 0 ]",bd=5,relief=RIDGE,bg="#009688",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_category.place(x=990,y=120,height=150,width=300)

        self.lbl_product=Label(self.root,text="Total Product\n [ 0 ]",bd=5,relief=RIDGE,bg="#607b8b",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_product.place(x=330,y=300,height=150,width=300)

        self.lbl_sales=Label(self.root,text="Total Sales\n [ 0 ]",bd=5,relief=RIDGE,bg="#ffc107",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_sales.place(x=660,y=300,height=150,width=300)

        # Footer 
        lbl_footer=Label(self.root,text="IMS-Inventory Management System  |  Developed By Payal \n For any Technical Issue Contact: 7264xxxx45",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
