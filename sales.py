...
class salesClass:
    def __init__(self,root):
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15,"bold"),bg="#607d8d",fg="white",cursor="hand2").place(x=490,y=100,width=120,height=28)
        ...
        lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("goudy old style",20),bg="lightgreen").pack(side=TOP,fill=X)
        ...
        # image
        self.bill_photo=Image.open("Images\images2.png")
...
#*********************************************************************************
    ...
    def get_data(self,ev):
        ...
        fill_name=self.Sales_List.get(index_)
        #print(fill_name)
        self.bill_Area.delete('1.0',END)
        fp=open(f'bill/{fill_name}','r')
        for i in fp:
