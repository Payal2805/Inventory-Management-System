...
class categoryClass:
    def __init__(self,root):
        ...
        lbl_name=Label(self.root,text="Enter Category Name ",font=("goudy old style",30),bg="White").place(x=20,y=100)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",18),bg="lightyellow").place(x=20,y=170,width=250)

        but_name=Button(self.root,text="ADD",command=self.add,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=280,y=170,width=120,height=30)
        but_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="red",fg="white",cursor="hand2").place(x=410,y=170,width=120,height=30)

        #  Category Details

        cat_frame=Frame(self.root,bd=3,relief=RIDGE)
        cat_frame.place(x=550,y=100,width=450,height=100)
        ...
        # Images
        self.im1=Image.open("Images\images3.png")
        ...
        self.im2=Image.open("Images\images1.png")
        self.im2=self.im2.resize((450,250),Image.ANTIALIAS)
        self.im2=ImageTk.PhotoImage(self.im2)

        self.lbl_im2=Label(self.root,image=self.im2,bd=2,relief=RAISED)
        self.lbl_im2.place(x=550,y=220)
        self.show()
